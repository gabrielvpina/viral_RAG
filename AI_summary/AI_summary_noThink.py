...
def analyze_viral_sequences(json_file_path, taxonomy_data_path, output_json_path=None):
    ...
    template = """
    You are an expert in virology and will analyze some information of potential viral sequences from a bioinformatics analysis. Here is the information:
    ...
    Based on this information, make a text (maximum of 200 words) about the taxonomy information (hosts), and evaluate if the sequence above is a known virus, a novel virus, or a non-viral sequence. Talk about the demarcation criteria of the taxonomy group.
    """
...
if __name__ == "__main__":
    ...
    output_file = "viral_analysis_results_with_summaries.json"  # Path for output
